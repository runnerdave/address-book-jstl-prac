<%--@elvariable id="contacts" type="java.util.Set<net.runnerdave.model.Contact>"--%>
<!DOCTYPE html>
<html>
<head>
    ...
    <c:otherwise>
        <c:forEach items="${contacts}" var="contact">
            ...
            <c:if test="${contact.birthday != null}">
                <fmt:message
                        key="label.birthday"/>: ${contact.birthday.month.getDisplayName('FULL', pageContext.response.locale)}
                &nbsp;${contact.birthday.dayOfMonth}
                <br/>
            </c:if>
            <fmt:message key="label.creationDate"/>: <fmt:formatDate value="${contact.oldDateCreated}" type="both"
